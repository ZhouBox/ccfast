...
public:
    ...
    type_const_value parse(const std::string& str_, const std::string& para_)
    {
...
public:
    ...
    type_const_value parse(const std::string& str_, const std::string& para_)
    {
        ...
        } else
        {
            ...
            std::string::size_type _posValue = str_.find('&', _posBegin);
...
struct fast_parse
{
    void parse(const std::string& str_, ParametersValues<T>& pv_)
    {
...
{
    void parse(const std::string& str_, ParametersValues<std::string>& pv_)
    {
        StringList _re = split(str_, '&');
        for (auto _n : _re)
        {
